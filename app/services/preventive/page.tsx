      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-[#F7D1D1]/30 to-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-semibold mb-6 text-[#3C3C3C]">Preventive Dental Care</h1>
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-semibold mb-6 text-[#3C3C3C]">The Foundation of Dental Health</h2>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-[#3C3C3C]/80">Comprehensive exams</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">Professional cleanings</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">Early intervention</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">Personalized care</span>
                </div>
              </div>
              <Link href="/contact">
                <Button 
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-full shadow-lg">
                <div className="bg-[#F7D1D1]/20 h-16 w-16 rounded-full flex items-center justify-center">
                  <ShieldCheck className="h-8 w-8 text-[#B87333]" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#F7D1D1]/10">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold mb-4 text-[#3C3C3C]">Our Preventive Services</h2>
            ...
            {preventiveServices.map((service, index) => (
              <Card key={index} className="border-none rounded-[8px] shadow-lg transition-all duration-300 hover:shadow-xl overflow-hidden group bg-white">
                ...
                <CardContent className="p-6">
                  ...
                  <h4 className="text-sm font-medium mb-2 text-[#3C3C3C]">Benefits:</h4>
                  <ul className="mb-6 space-y-2">
                    {service.benefits.map((benefit, i) => (
                      <li key={i} className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-[#B87333] mr-2 mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-[#3C3C3C]/80">{benefit}</span>
                      </li>
                    ))}
                  </ul>
                </CardContent>
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[8px] shadow-sm">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-2">How often should I visit the dentist for preventive care?</h3>
            ...
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[8px] shadow-sm">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-2">Are dental X-rays safe?</h3>
              <p className="text-[#3C3C3C]/80">
            ...
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[8px] shadow-sm">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-2">What is the best way to prevent cavities between dental visits?</h3>
              <p className="text-[#3C3C3C]/80">
