          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            <div className="lg:w-1/2 space-y-6">
              <h1 className="text-4xl md:text-5xl font-semibold text-[#3C3C3C] leading-tight">
                Restorative <span className="text-[#D8A7B1]">Dentistry</span>
              </h1>
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-sm text-[#3C3C3C]/80">Protect weak teeth from fracturing</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Restore broken or worn teeth</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Cover teeth with large fillings</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-[#F7D1D1]/20 hover:border-[#D8A7B1]/40">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Replace one or more missing teeth</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Prevent remaining teeth from shifting</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Restore ability to speak and chew properly</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-[#F7D1D1]/20 hover:border-[#D8A7B1]/40">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Replace single or multiple teeth</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Preserve jaw bone structure</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Provide superior stability and comfort</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-[#F7D1D1]/20 hover:border-[#D8A7B1]/40">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Save teeth with deep decay or infection</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Relieve severe toothache pain</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Comfortable procedure with modern techniques</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-[#F7D1D1]/20 hover:border-[#D8A7B1]/40">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Full dentures for complete tooth loss</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Partial dentures for some natural teeth</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Custom-fit for comfort and natural appearance</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-[#F7D1D1]/20 hover:border-[#D8A7B1]/40">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-2 mb-6">
                  ...
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">Strengthen teeth and prevent further decay</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#B87333] mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-[#3C3C3C]/80">More durable than traditional fillings</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-4">
                <h3 className="font-medium text-[#3C3C3C]">Dental Implants</h3>
                <p className="text-sm text-[#3C3C3C]/70">Replacement of multiple missing teeth with implants</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-4">
                <h3 className="font-medium text-[#3C3C3C]">Dental Crowns</h3>
                <p className="text-sm text-[#3C3C3C]/70">Restoration of severely damaged teeth</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-4">
                <h3 className="font-medium text-[#3C3C3C]">Dental Bridge</h3>
                <p className="text-sm text-[#3C3C3C]/70">Front teeth restoration with porcelain bridge</p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto grid gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#F7D1D1]/20">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-3">How long do dental implants last?</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#F7D1D1]/20">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-3">Is a root canal painful?</h3>
              <p className="text-[#3C3C3C]/80">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#F7D1D1]/20">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-3">How do I know if I need a crown or a filling?</h3>
              <p className="text-[#3C3C3C]/80">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#F7D1D1]/20">
              <h3 className="text-lg font-medium text-[#3C3C3C] mb-3">Does insurance cover restorative dental work?</h3>
              <p className="text-[#3C3C3C]/80">
