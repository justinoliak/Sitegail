  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-[#F7D1D1]/30 to-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-semibold mb-6 text-[#3C3C3C]">Facial Aesthetic Services</h1>
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-block text-[#D8A7B1] font-medium tracking-wider mb-5 uppercase text-sm">Featured Treatment</span>
              <h2 className="text-3xl font-semibold mb-6 text-[#3C3C3C]">Introducing Emface™</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="bg-[#F7D1D1]/10 p-4 rounded-xl text-center">
                  <h3 className="text-xl font-semibold mb-2 text-[#B87333]">23%</h3>
                  <p className="text-sm text-[#3C3C3C]/80">More Lift</p>
                </div>
                <div className="bg-[#F7D1D1]/10 p-4 rounded-xl text-center">
                  <h3 className="text-xl font-semibold mb-2 text-[#B87333]">37%</h3>
                  <p className="text-sm text-[#3C3C3C]/80">Fewer Wrinkles</p>
                </div>
                <div className="bg-[#F7D1D1]/10 p-4 rounded-xl text-center">
                  <h3 className="text-xl font-semibold mb-2 text-[#B87333]">30%</h3>
                  <p className="text-sm text-[#3C3C3C]/80">Muscle Tone Gain</p>
                </div>
              </div>
              
              <div className="flex flex-wrap gap-6 mb-8">
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">No Needles</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">Zero Downtime</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">FDA Cleared</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-[#B87333] mr-2" />
                  <span className="text-[#3C3C3C]/80">Natural Results</span>
                </div>
              </div>
              
              <Link href="/facial-aesthetics">
                <Button 
                  className="bg-[#B87333] hover:bg-[#B87333]/90 text-white rounded-[24px] px-6 py-3 font-medium transition-all duration-300 shadow-sm"
                >
            ...
            <div className="relative">
              <div className="relative aspect-[4/5] rounded-[16px] overflow-hidden shadow-xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#3C3C3C]/30 to-transparent"></div>
              </div>
              
              {/* FDA Badge */}
              <div className="absolute -right-4 -bottom-4 bg-white rounded-full p-4 shadow-lg">
                <div className="bg-[#F7D1D1]/30 h-16 w-16 rounded-full flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-xs font-bold text-[#B87333]">FDA</p>
                    <p className="text-[10px] text-[#3C3C3C]/80">CLEARED</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-[#F7D1D1]/10">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold mb-4 text-[#3C3C3C]">Our Aesthetic Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {aestheticServices.map((service, index) => (
              <Card key={index} className="border-none rounded-[8px] shadow-lg transition-all duration-300 hover:shadow-xl overflow-hidden group bg-white">
                <div className="h-48 relative bg-[#F7D1D1]/20">
                  ...
                  <ul className="mb-6">
                    {service.features.map((feature, i) => (
                      <li key={i} className="flex items-start mb-2">
                        <Shield className="h-5 w-5 text-[#B87333] mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-[#3C3C3C]/80">{feature}</span>
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold mb-4 text-[#3C3C3C]">Why Choose Our Aesthetic Services</h2>
            <p className="text-lg text-[#3C3C3C]/80 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[16px] text-center">
              <div className="w-16 h-16 rounded-full bg-[#F7D1D1] flex items-center justify-center mx-auto mb-4">
                <Star className="h-8 w-8 text-[#B87333]" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-[#3C3C3C]">Medical Expertise</h3>
            ...
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[16px] text-center">
              <div className="w-16 h-16 rounded-full bg-[#F7D1D1] flex items-center justify-center mx-auto mb-4">
                <Sparkles className="h-8 w-8 text-[#B87333]" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-[#3C3C3C]">Natural Results</h3>
              <p className="text-[#3C3C3C]/80">
            ...
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[16px] text-center">
              <div className="w-16 h-16 rounded-full bg-[#F7D1D1] flex items-center justify-center mx-auto mb-4">
                <Shield className="h-8 w-8 text-[#B87333]" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-[#3C3C3C]">Cutting-Edge Technology</h3>
              <p className="text-[#3C3C3C]/80">
            ...
            <div className="bg-[#F7D1D1]/10 p-6 rounded-[16px] text-center">
              <div className="w-16 h-16 rounded-full bg-[#F7D1D1] flex items-center justify-center mx-auto mb-4">
                <CheckCircle className="h-8 w-8 text-[#B87333]" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-[#3C3C3C]">Personalized Care</h3>
              <p className="text-[#3C3C3C]/80">
