          ...
          <div className="max-w-md w-full p-8 bg-white rounded shadow-lg">
            ...
            <div className="space-y-4">
              <p className="text-foreground/80">
                A critical error occurred while loading the application. This has been logged and we're working on it.
              </p>
              ...
              <div className="mt-6 space-y-4">
                <Button 
                  onClick={reset}
                  className="w-full bg-accent-mint text-white hover:bg-accent-mint-dark"
                >
                  Try again
                </Button>
              </div>
