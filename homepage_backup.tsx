            ...
            <div className="order-2 lg:order-1 space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="hero-title text-charcoal">
                  Your Smile Deserves
                  <span className="text-accent-mint block">Exceptional Care</span>
                </h1>
                <p className="hero-subtitle max-w-2xl">
                  Experience personalized dental care in a comfortable, modern environment. Dr. Gail Krishnan and her team are committed to helping you achieve optimal oral health.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="group border-0 rounded-3xl shadow-soft card-hover-lift overflow-hidden bg-white relative">
              ...
              <div className="p-8">
                ...
                <p className="text-slate-600 mb-6 leading-relaxed">
                  Maintain your smile's health with regular cleanings, exams, and early intervention.
                </p>
                <Link 
                  href="/services" 
            ...
            <Card className="border border-gray-100 rounded-xl shadow-sm card-hover-lift overflow-hidden bg-white">
              ...
              <div className="p-6">
                ...
                <p className="text-charcoal/70 mb-4 leading-relaxed">
                  Transform your smile with aesthetic treatments including whitening and veneers.
                </p>
                <Link 
                  href="/services" 
            ...
            <Card className="border border-gray-100 rounded-xl shadow-sm card-hover-lift overflow-hidden bg-white">
              ...
              <div className="p-6">
                ...
                <p className="text-charcoal/70 mb-4 leading-relaxed">
                  Regain full function and confidence with advanced restorative solutions.
                </p>
                <Link 
                  href="/services" 
                  className="inline-flex items-center text-accent-mint font-medium hover:underline transition-colors"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-charcoal/70 mb-6 leading-relaxed text-lg">
                Dr. Krishnan combines extensive education and clinical expertise with a genuinely compassionate approach to patient care. She believes in creating partnerships with her patients and developing personalized treatment plans.
              </p>
